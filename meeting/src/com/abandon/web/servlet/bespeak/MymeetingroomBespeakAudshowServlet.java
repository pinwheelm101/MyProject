...
/**
 * Servlet implementation class MymeetingroomBespeakAudshowServlet
 */
@WebServlet("/MymeetingroomBespeakAudshowServlet")
public class MymeetingroomBespeakAudshowServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MymeetingroomBespeakAudshowServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/view/bespeak/mymeetingroom_bespeak_audshow.jsp").forward(request, response);
	}
