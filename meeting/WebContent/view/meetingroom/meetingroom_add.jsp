...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//给文本框添加事件
		$("#meetingroomId").blur(function(){
			var meetId = $(this).val();
			if(meetId.length>0){
				//提交
				$.post("CheackMeetingroomIdServlet",{meetingroomId:meetId},function(data){
...
<body>
<div  >
	<font size="2" style="color:green;"></font>
	<h4 class="page-header">会议室管理<small>添加</small></h4>
    <div align="center" style="color: red" >${info }</div>
    <form class="form-horizontal" action="MeetingroomAddServlet" method="post">
        <input type="hidden" name="enquipmentIds" id="enquipmentId" value=""/>
       <div class="form-group"> 
        	<label  class="col-xs-2 control-label " > 编号</label>
            <div class="col-xs-4">
            	<input type="text" name="meetingroomId" onblur="" id="meetingroomId"  placeholder="请输入编号"  class="form-control" />
             	<div id="idinfo" ></div>
             </div>
        </div>
    	<div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<input type="text" name="meetingroomName" id="name" placeholder="请输入名称"  class="form-control" />
             </div>
        </div>
        <div class="form-group"> 
        	<label for="name" class="col-xs-2 control-label " > 大小</label>
            <div class="col-xs-4">
            	<input type="text" name="meetingroomSize" id="name" placeholder="请输会议室大小"  class="form-control" />
             </div>
        </div>
        <div class="form-group"> 
  ...
  请选择
         ...
         <div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<textarea class="form-control" rows="3" name="meetingroomName"></textarea>
             </div>
        </div>
          <div class="form-group"> 
