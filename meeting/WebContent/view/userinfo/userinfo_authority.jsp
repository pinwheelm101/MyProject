...
<body>
<div  >
	<h4 class="page-header">用户管理<small>用户信息查询</small></h4>

<div class="container">
<form action="UserAnthorityServlet" method="post"  class="form-inline" role="form">
...
<di:table name="list" class="table table-striped" pagesize="4" requestURI="UserAnthorityServlet">
	<di:column property="userId" title="账号"></di:column>
	...
	<di:column href="UserAnthorityChangeServlrt"  paramId="userId" paramProperty="userId" value="权限变更" title="权限变更"></di:column>	
</di:table>
</div>
