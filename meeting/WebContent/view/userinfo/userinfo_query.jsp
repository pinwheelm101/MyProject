...
<div class="container">
<form action="UserInfoSelectServlet" method="post"  class="form-inline" role="form">
...
<di:table name="list" class="table table-striped" pagesize="4" requestURI="UserInfoSelectServlet">
	...
	<di:column href="UserInfoShowServlet"  paramId="userId" paramProperty="userId" value="查看" title="查看"></di:column>	
</di:table>
</div>
