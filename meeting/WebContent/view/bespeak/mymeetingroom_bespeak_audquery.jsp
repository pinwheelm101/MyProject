...
<body>
	<h4 class="page-header">会议室预约<small>我的审核</small></h4>

<div class="container">
<form class="form-inline" role="form" action="MymeetingroomBespeakAudqueryServlet" method="post">
...
<d:table class="table table-striped" name="list" pagesize="8"
			requestURI="MymeetingroomBespeakAudqueryServlet">
			...
			<d:column href="MymeetingroomBespeakAudshowServlet" paramId="bespeakId" paramProperty="bespeakId" value="查看" title="查看"></d:column>
		</d:table>
