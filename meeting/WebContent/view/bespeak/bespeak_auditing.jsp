         ...
         <div class="form-group"> 
            ...
            <div class=" col-xs-offset-1 col-xs-4">
            	<div class="radio-inline">
                	<label>
                    	<input type="radio" name="bespeakState" value="1"  ${bespeak.bespeakState=='1'||bespeak.bespeakState=='0'?'checked':''}/>审核不通过
                    </label>
                </div>
                 <div class="radio-inline">
                	<label>
                    	<input type="radio" name="bespeakState" value="2" ${bespeak.bespeakState=='2'?'checked':''} />审核通过
                    </label>
                </div>
             </div>
        </div>
