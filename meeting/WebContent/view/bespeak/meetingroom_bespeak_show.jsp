    ...
    <form class="form-horizontal">
       ...
       <div class="form-group"> 
        ...
        <div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<p class="form-control-static">
            	<fmt:formatDate value="${bespeak.endTime }"  type="both"/>
            	</p>
             </div>
        </div>
         <div class="form-group"> 
         ...
         <div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<p class="form-control-static">   
            	<fmt:formatDate value="${bespeak.applyTime }"  type="both"/>
            	</p>
             </div>
        </div>
        <div class="form-group"> 
	...
	<c:forEach items="${mulist }" var="mu">	
		${mu.userName },
         ...
         <div class="form-group"> 
            ...
            <div class="col-xs-4">
            	<p class="form-control-static">备注</p>
             </div>
        </div>
         <div class="form-group"> 
            ...
            <div class="  col-xs-4">
				...
				${bespeak.bespeakState=='2'?'审核未通过':'' }</p>
             </div>
        </div>
          <div class="form-group"> 
        	<label for="name" class="col-xs-2 control-label " > 审核人</label>
            <div class="col-xs-4">
            	<p class="form-control-static">${bespeak.auditingMan }</p>
             </div>
        </div>
         <div class="form-group"> 
         ...
         <div class="form-group"> 
          ...
          <div class="form-group"> 
            ...
            <div class="col-sm-offset-1 col-xs-4">
            	<a class="btn btn-default" href="MeetingroomBespeakQueryServlet" >返回上一级</a>
             </div>
        </div>
