				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						...
						<ul
							...
							<li><a href="view/main/profile.jsp"  target="mainframe"> <i class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="loginServlet"> <i class="icon-off"></i> 退出
							</a></li>
						 </ul></li>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a
						href="stagingServlet" target="mainframe">
			...
			<div class="main-content" id="mains">
				<iframe id="mainframe" name="mainframe" src="view\main\profile.jsp"
